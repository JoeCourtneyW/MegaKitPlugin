...
public class LocationUtil
{
	...
	public static String serialize(Location loc){
		...
		serialized.add(MathUtil.roundTwoPoints(loc.getX()) + "");
		serialized.add(MathUtil.roundTwoPoints(loc.getY()) + "");
		serialized.add(MathUtil.roundTwoPoints(loc.getZ()) + "");
		serialized.add(MathUtil.roundTwoPoints(loc.getYaw()) + "");
		serialized.add(MathUtil.roundTwoPoints(loc.getPitch()) + "");
